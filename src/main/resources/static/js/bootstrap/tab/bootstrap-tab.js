...
(function ($, window, document, undefined) {
    ...
    BaseTab.prototype.loadData = function () {
        ...
        for (var i = 0; i < data.length; i++) {
            if (this.options.loadAll || this.options.showIndex == i) {
                if (data[i].url) {
                    $("#" + data[i].id).html("<iframe style='width: 100%;height:83%;boxder:none;' frameborder='no' border='0' marginwidth='0' marginheight='0' scrolling='yes' allowtransparency='yes' src='/"+data[i].url+"' ></iframe>");
                ...
                (function (id, url) {
                    self.$element.find(".nav-tabs a[href='#" + id + "']").on('show.bs.tab', function () {
                        if (!self.stateObj[id]) {
                            $("#" + id).html("<iframe style='width: 100%;height:83%;boxder:none;' frameborder='no' border='0' marginwidth='0' marginheight='0' scrolling='yes' allowtransparency='yes' src='/"+url+"' ></iframe>");
    ...
    BaseTab.prototype.addTab=function (obj) {
        ...
        if($(showObj).html()==undefined){
            ...
            $("#" + obj.id).html("<iframe style='width: 100%;height:83%;boxder:none;' frameborder='no' border='0' marginwidth='0' marginheight='0' scrolling='yes' allowtransparency='yes' src='/"+obj.url+"' ></iframe>");
